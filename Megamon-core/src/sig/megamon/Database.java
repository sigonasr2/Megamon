...
public class Database {
		...
		Megamon.megamonDatabase = new LinkedList<MegamonCreature>(Arrays.asList(
					new MegamonCreature("1_icon.png","1.png","1_back.png",
							...
							new CreatureMoveLinker[]{
								new CreatureMoveLinker("M.Buster",1),
								new CreatureMoveLinker("Degrade",1),
								new CreatureMoveLinker("Bubble Lead",8),
								new CreatureMoveLinker("Slide",15),
								new CreatureMoveLinker("Bubble Beam",22),
								new CreatureMoveLinker("Water Shield",28),
								new CreatureMoveLinker("Water Balloon",38),
							}),
					new MegamonCreature("2_icon.png","2.png","2_back.png",
							"Mega Man", "The OG Megaman.", 1, 1,
							CreatureType.WATER, 59, 63, 80, 65, 58,
							3, 128, ExperienceRate.MEDIUM_SLOW,
							new CreatureMoveLinker[]{
								new CreatureMoveLinker("M.Buster",1),
								new CreatureMoveLinker("Degrade",1),
								new CreatureMoveLinker("Bubble Lead",8),
								new CreatureMoveLinker("Slide",15),
								new CreatureMoveLinker("Bubble Beam",24),
								new CreatureMoveLinker("Water Shield",30),
								new CreatureMoveLinker("Water Balloon",40),
							}),
					new MegamonCreature("3_icon.png","3.png","3_back.png",
							"Rush Mega Man", "Now equipped with the Rush Power Adapter. Let's go!", 1, 1,
							CreatureType.WATER, CreatureType.STRENGTH,
							79, 83, 100, 78, 85,
							3, 256, ExperienceRate.MEDIUM_SLOW,
							new CreatureMoveLinker[]{
								new CreatureMoveLinker("M.Buster",1),
								new CreatureMoveLinker("Degrade",1),
								new CreatureMoveLinker("Bubble Lead",8),
								...
								new CreatureMoveLinker("Bubble Beam",24),
								new CreatureMoveLinker("Water Shield",30),
								new CreatureMoveLinker("Quick Jab",36),
								new CreatureMoveLinker("Water Balloon",42),
								new CreatureMoveLinker("Haymaker",51),
								new CreatureMoveLinker("Last Round",58),
							}),
					new MegamonCreature("4_icon.png","4.png","4_back.png",
							"Basic P", "Basic Protoman", 1, 1,
							CreatureType.FIRE, 44, 48, 65, 50, 43,
							3, 64, ExperienceRate.MEDIUM_SLOW,
							new CreatureMoveLinker[]{
								new CreatureMoveLinker("P.Buster",1),
								new CreatureMoveLinker("Jamming",1),
								new CreatureMoveLinker("Ember",8),
								new CreatureMoveLinker("Proto Song",15),
								new CreatureMoveLinker("Fire Armor",22),
								new CreatureMoveLinker("Magma Bazooka",28),
								new CreatureMoveLinker("Fire Spin",38),
							}),
					new MegamonCreature("5_icon.png","5.png","5_back.png",
							"Proto Man", "Proto Man.", 1, 1,
							CreatureType.FIRE, 58, 64, 58, 80, 65,
							3, 128, ExperienceRate.MEDIUM_SLOW,
							new CreatureMoveLinker[]{
									new CreatureMoveLinker("P.Buster",1),
									new CreatureMoveLinker("Jamming",1),
									new CreatureMoveLinker("Ember",8),
									new CreatureMoveLinker("Proto Song",15),
									new CreatureMoveLinker("Fire Armor",24),
									new CreatureMoveLinker("Magma Bazooka",33),
									new CreatureMoveLinker("Fire Spin",41),
							}),
					new MegamonCreature("6_icon.png","6.png","6_back.png",
							"Break Man", "Break all the things.", 1, 1,
							CreatureType.FIRE, 
							78, 84, 78, 100, 85,
							3, 256, ExperienceRate.MEDIUM_SLOW,
							new CreatureMoveLinker[]{
									...
									new CreatureMoveLinker("Proto Song",15),
									new CreatureMoveLinker("Fire Armor",24),
									new CreatureMoveLinker("Proto Shield",32),
									new CreatureMoveLinker("Magma Bazooka",35),
									new CreatureMoveLinker("Fire Spin",43),
									new CreatureMoveLinker("Shield Charge",50),
									new CreatureMoveLinker("Ultimate Defense",57),
							}),
					new MegamonCreature("2_icon.png","2.png","2_back.png",
							"Mega Man", "The OG Megaman.", 1, 1,
							CreatureType.WATER, 59, 63, 80, 65, 58,
	...
	public static void SetupEvolutionDatabase() {
		Megamon.megamonDatabase.get(0).setEvolutionRules(Arrays.asList(new Evolution(Megamon.megamonDatabase.get(1),16))); //Basic M -> Mega Man
		Megamon.megamonDatabase.get(1).setEvolutionRules(Arrays.asList(new Evolution(Megamon.megamonDatabase.get(2),36))); //Mega Man -> Rush Mega Man
		Megamon.megamonDatabase.get(3).setEvolutionRules(Arrays.asList(new Evolution(Megamon.megamonDatabase.get(4),16))); //Basic P -> Proto Man
		Megamon.megamonDatabase.get(4).setEvolutionRules(Arrays.asList(new Evolution(Megamon.megamonDatabase.get(5),32))); //Proto Man -> Break Man
	}
}
